...
import stateWiseAnalysisMA.EquipmentWiseAnalysis.Map;
import stateWiseAnalysisMA.EquipmentWiseAnalysis.Reduce;
	...
	public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, DoubleWritable> {  
	     ...
	     public void map(LongWritable key, Text value, OutputCollector<Text, DoubleWritable> output, Reporter reporter) throws IOException {  
	       ...
	       try{
	    	   ...
	    	   String hour = getHour(consumption.getTimeStamp());
	    	   myKey.set(hour);
	     ...
	     public String getHour(String code){
	   ...
	   public static void main(String[] args) throws Exception {  
	     ...
	     FileOutputFormat.setOutputPath(conf, new Path("hdfs://localhost:54310/user/Devashri/hourlyLoadoutput/hourlyConsumptionHeatingt"));  
