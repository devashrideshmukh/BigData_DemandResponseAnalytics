...
public class EquipmentWiseAnalysis {
	public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, DoubleWritable> {  
	     ...
	     public void map(LongWritable key, Text value, OutputCollector<Text, DoubleWritable> output, Reporter reporter) throws IOException {  
	       ...
	       try{
	    	   ...
	    	   myKey.set(equipConsumption.getMonth());
	           ...
	           Double valueConsumedByAppliance = elexByFacility;
	   ...
	   public static void main(String[] args) throws Exception {  
	     ...
	     FileOutputFormat.setOutputPath(conf, new Path("hdfs://localhost:54310/user/Devashri/output/facilityEquip"));  
