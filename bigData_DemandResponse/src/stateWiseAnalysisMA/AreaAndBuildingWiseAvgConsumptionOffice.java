...
public class AreaAndBuildingWiseAvgConsumptionOffice {
	...
	public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, DoubleWritable> {  
	     ...
	     public void map(LongWritable key, Text value, OutputCollector<Text, DoubleWritable> output, Reporter reporter) throws IOException {  
	       ...
	       try{
	    	   ...
	    	   String createdKey = consumption.getBuildingCode()+consumption.getRegionCode()+month;
	           ...
	           if(createdKey.substring(0,4).equals("LOMV")){
	   ...
	   public static void main(String[] args) throws Exception {  
	     ...
	     FileOutputFormat.setOutputPath(conf, new Path("hdfs://localhost:54310/user/Devashri/outputOffice/LOMarthasMonthly"));  
